...
from ...helpers.coingecko import getHistoricalTokenData
load_dotenv('../../../.env')
...
class TokenPriceHistoryTool(BaseTool):
    """A tool for generating syntetic data with an external api."""

    name: str = "balance"
    description: str = (
        "This tool enables the ai agent to get historical price history for tokens on a blockchain"
        "To use this tool: You should pass in a valid json which contains a key value for token_contract_address and chain_name if none are specified, assume ethereum."
